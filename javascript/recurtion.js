/* Recursion to Create a CountdownPassed */
/**
Recurtion function that returns an array of consecutive integers starting with 1 through the number passed to the function.
...
function countup(n) {
  if (n < 1) {
    ...
    countArray.push(n);  // Use unshift() for reverse
    return countArray;
  }
}
